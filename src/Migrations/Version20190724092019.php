 ...
 */
final class Version20190724092019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bike_owner (id INT AUTO_INCREMENT NOT NULL, gender INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, birth_date DATE DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, bike_id INT NOT NULL, customer_id INT NOT NULL, track_date DATE NOT NULL, created_at DATETIME NOT NULL, status INT NOT NULL, INDEX IDX_42C84955D5A4816F (bike_id), INDEX IDX_42C849559395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bike ADD bike_owner_id INT DEFAULT NULL, CHANGE km km INT DEFAULT NULL, CHANGE status status SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE bike ADD CONSTRAINT FK_4CBC378026EE9171 FOREIGN KEY (bike_owner_id) REFERENCES bike_owner (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4CBC378026EE9171 ON bike (bike_owner_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bike DROP FOREIGN KEY FK_4CBC378026EE9171');
        ...
        $this->addSql('DROP INDEX UNIQ_4CBC378026EE9171 ON bike');
        $this->addSql('ALTER TABLE bike DROP bike_owner_id, CHANGE km km INT DEFAULT NULL, CHANGE status status SMALLINT DEFAULT NULL');
    }
}
